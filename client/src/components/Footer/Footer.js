        ...
        <footer className="footer">
            <div className="footer_container">
                <div className="footer_about">
                    ...
                    <p>
                        We are a brand focused on bringing the best and only the
                        best of premium and high end fashion items to your
                        doorstep. Browse through different categories of
                        products to find the one that best suit your taste.
                ...
                <div className="footer_categories">
                    ...
                    <div>
                        ...
                        <Link to="/category/jackets-and-hoodies">
                            Jackets and Hoodies
                        </Link>
                    </div>
                </div>
                ...
                <div className="footer_contact">
                    ...
                    <div className="footer_contact_methods">
                        <div className="contact_method">
                            <span>A.</span>
                            <p>
                                Street 15, Hostel City , Comsats University ,
                                Islamabad
                            </p>
                        </div>
                        <div className="contact_method">
                        ...
                        <div className="contact_method">
                            <span>T.</span>
                            <p>
                                <a href="tel:+923130159250">+923130159250</a>
                            </p>
                        </div>
                    </div>
                </div>
