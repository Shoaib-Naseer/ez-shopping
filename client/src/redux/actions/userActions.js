...
export const editProfile = (formData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(
            `http://localhost:3001/api/users/profile/${userInfo._id}/`,
            formData,
            config
        )
...
export const updatePassword = (formData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(
            `http://localhost:3001/api/users/profile/password/${userInfo._id}`,
            formData,
            config
        )
        dispatch({
...
export const getAddress = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(
            `http://localhost:3001/api/users/profile/${userInfo._id}/address/${id}`,
            config
        )
...
export const addAddress = (formData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(
            `http://localhost:3001/api/users/profile/${userInfo._id}/address/`,
            formData,
            config
        )
...
export const deleteAddress = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete(
            `http://localhost:3001api/users/profile/${userInfo._id}/address/${id}`,
            config
        )
