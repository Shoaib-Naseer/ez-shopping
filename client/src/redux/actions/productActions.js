...
export const getProducts =
    (keyword = '', pageNumber = '', sortKey = '', sortValue = '') =>
    async (dispatch) => {
        try {
            dispatch({ type: actionTypes.GET_PRODUCTS_REQUEST })

            const { data } = await axios.get(
                `http://localhost:3001/api/products?keyword=${keyword}&pageNumber=${pageNumber}&sortKey=${sortKey}&sortValue=${sortValue}`
            )
...
export const getCategoryProducts =
    (category = 'dresses', pageNumber = '', sortKey = '', sortValue = '') =>
    async (dispatch) => {
        try {
            dispatch({ type: actionTypes.GET_CATEGORY_PRODUCTS_REQUEST })

            const { data } = await axios.get(
                `http://localhost:3001/api/products/category/?category=${category}&pageNumber=${pageNumber}&sortKey=${sortKey}&sortValue=${sortValue}`
            )
...
export const getGenderProducts =
    (gender = 'unisex', pageNumber = '', sortKey = '', sortValue = '') =>
    async (dispatch) => {
        try {
            dispatch({ type: actionTypes.GET_GENDER_PRODUCTS_REQUEST })

            const { data } = await axios.get(
                `http://localhost:3001/api/products/gender/?gender=${gender}&pageNumber=${pageNumber}&sortKey=${sortKey}&sortValue=${sortValue}`
            )
...
export const getTopProducts = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(
            'http://localhost:3001/api/products/top'
        )
