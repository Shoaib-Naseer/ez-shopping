...
function TabPanel(props) {
    ...
    return (
        ...
        >
            {value === index && (
                <div className="tab_panel_container">{children}</div>
            )}
        </div>
    )
}
...
const ProductPage = () => {
    ...
    var reducedAddedItems = addedItems.reduce(
        (count, item) => item.qty + count,
        0
    )
                ...
                <div className="product_page_container">
                    <div className="product_basic_info">
                        ...
                        <div className="product_title">
                            ...
                            <div className="product_title_double">
                                <h4>Brand:</h4> <h2>{product?.brand}</h2>
                            </div>
                            <div className="product_title_double">
                                <h4>Ratings:</h4>{' '}
