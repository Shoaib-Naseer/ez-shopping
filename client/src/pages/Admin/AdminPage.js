            ...
            <div className="admin_container">
                ...
                <div className="screen">
                    ...
                    <Switch>
                        ...
                        <Route exact path={`${url}/orders/page/:page`}>
                            {' '}
                            <AllOrders />{' '}
                        </Route>
                        <Route exact path={`${url}/order/:id`}>
                            {' '}
                            <Order />{' '}
                        </Route>
                        <Route exact path={`${url}/products/:pageNumber`}>
                            {' '}
                            <AllProducts />{' '}
                        </Route>
                        ...
                        <Route exact path={`${url}/addproduct`}>
                            {' '}
                            <AddProduct type="add" />{' '}
                        </Route>
                        <Route exact path={`${url}/editproduct/:id`}>
                            {' '}
