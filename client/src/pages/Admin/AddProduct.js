...
const AddProduct = ({ type }) => {
    ...
    const { newProduct, newProductLoading, newProductError } = useSelector(
    ...
    useEffect(() => {
        if (productDetails) {
            const formattedSizes = productDetails.product?.sizes?.map(
                (size) => {
                ...
                {type === 'add' && (
                    <section className="form">
                        ...
                        >
                            ...
                            {newProductError && (
                                <p className="error">{newProductError}</p>
                            )}
                                ...
                                <Grid item xs={12} sm={6}>
                                    <div className="select">
                                        ...
                                        >
                                            ...
                                            <option value="jackets and hoodies">
                                                Jackets and Hoodies
                                            </option>
                                            <option value="others">
                                                Others
